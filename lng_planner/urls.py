...
urlpatterns = [
    ...
    # Simulation comments
    path('simulation/<int:simulation_id>/comment/add/', views.add_simulation_comment, name='add_comment'),
    path('comment/<int:comment_id>/delete/', views.delete_simulation_comment, name='delete_comment'),
